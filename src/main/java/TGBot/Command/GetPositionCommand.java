...
public class GetPositionCommand extends AnonymizerCommand {

    private final AnonymousService mAnonymouses;

    public GetPositionCommand(AnonymousService anonymouses){
        super("get_position","Show the position in given queue of given client. Format: /get_position [name of queue] [given number phone]\n");
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] strings){
        ...
        if (!mAnonymouses.hasAnonymous(user)){
            ...
            if (numberPhone==null) sb.append("Please correct your number phone!");
                ...
                String url = "/api/getMyPosition?queueName=" + nameQueue + "&phoneNumber=" + numberPhone;
